...
-- Función para crear ESP con caja interna
local function createESP(player)
    ...
    -- Crear caja transparente dentro del jugador
    local box = Instance.new("BoxHandleAdornment")
    box.Adornee = hrp
    box.Size = Vector3.new(2, 5, 1) -- Tamaño aproximado de jugador
...
print("✅ ESP CARGADO - Método de caja interna")
]])()
